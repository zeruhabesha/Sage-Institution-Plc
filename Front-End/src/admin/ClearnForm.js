...
function Clearn() {
  ...
  return (
    <div>
      ...
      >
        <summary>
          Before Insert the data in the clearnace/Withdrawal form read the
          policy.
        </summary>
        <p
          style={{
        ...
        <div class="card-box mb-30">
          <div class="pd-20">
            <h4
              ...
              class="text-blue h4"
            >
              Sage Members clearnace/Withdrawal data
            </h4>
          </div>
          <div class="pb-20">
                ...
                <div class="pd-ltr-20 xs-pd-20-10">
                  <div class="min-height-200px">
                    <form>
                      ...
                      <select className="sectform">
                        <option>Deferred</option>
                        <option>100% Fee Payer</option>
                        <option>50% Fee Payer</option>
                      </select>
                      <label> Reason For Withdrawal </label>
                      <select className="sectform">
                        <option>Transfer to other institution</option>
                        <option>Persenal Case</option>
                        <option>Financial Problem</option>
                        <option>Displinary Case</option>
                        <option>Others</option>
                      </select>
                      <div class="form-group">
                        <label for="Phone">Department Head</label>
                        <input
                          type="text"
                          class="form-control"
                          id="Phone"
                          placeholder="Department Head Sign"
                        />
                      </div>
                      <div class="form-group">
                        <label for="User">Acadamic Dean</label>
                        <input
                          type="text"
                          class="form-control"
                          id="User"
                          placeholder="Acadamic Dean Sign"
                        />
                      </div>

                      <div class="form-group">
                        <label for="User">Registrar</label>
                        <input
                          type="text"
                          class="form-control"
                          id="User"
