      ...
      <div class="dash-content">
            ...
            <button type="button" class="btn btn-primary" onClick={() => handleAddStud()} >
              Add Course
                    ...
                    <th>Start-date</th>
										...
										<th>Schedule</th>
                    <th>Status</th>
                    {currentUser.user.role === "staffs"  && ( 		<th>Actions</th> )}
									</tr>
								</thead>
								<tbody>
        ...
        <tr key={user._id}>
          ...
          <td>{user.status}</td>
                    ...
                    {currentUser.user.role === "staffs"  && ( 
                   <td> <button type="button" class="btn btn-primary"  onClick={() =>handleEdit(user)}>
  <i className='fas fa-edit'></i>
</button>  </td>)} &nbsp;&nbsp;&nbsp;  {currentUser.user.role === "staffs"  && (  <td>
<button className='btn btn-danger' onClick={()=>{ window.confirm('Are you sure to delete this data', ) 
                                   && deletePost(hh)} } > <i className='fas fa-trash'></i></button> </td>)}
&nbsp;&nbsp;&nbsp; {currentUser.user.role === "staffs"  && ( 
 <td><button type="button" class="btn btn-secondary" onClick={()=> handleApprove(hh)}>
Activity
</button>  </td>)}&nbsp;&nbsp;&nbsp;             
