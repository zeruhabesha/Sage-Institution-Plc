  ...
  return (
    <div>
      ...
      <h1 style={{ textAlign: `center`, color: `brown` }}>
        Lost student ID card clearnace Form
      </h1>
      <details
        style={{
          textAlign: `center`,
      ...
      >
        <summary>
          Before Insert the data in the Lost student ID card clearnace form read
          the policy.
        </summary>
        <p
          style={{
        ...
        <div class="card-box mb-30">
          <div class="pd-20">
            <h4
              ...
              class="text-blue h4"
            >
              Sage Members Lost student ID card clearnace data
            </h4>
          </div>
          <div class="pb-20">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">
                  Lost student ID card clearnace
                </h5>
                <button
                  type="button"
                  class="close"
                ...
                <div class="pd-ltr-20 xs-pd-20-10">
                  <div class="min-height-200px">
                    <form>
                      ...
                      <div class="form-group">
                        <label for="Photo">Enrollment</label>
                        <input
                          type="text"
                          class="form-control"
                          id="Photo"
